...
namespace UI {
	...
	_declspec(selectany) vector<PICTURE_TYPE> STAGESELECT_LIST = {
		...
		{ T_STAGE_1,  {
			{},
			{"Picture/UI/StageSelect/GL_UI_StageTitle1.png"},
			{ "Picture/UI/StageSelect/GL_UI_StageTitle2.png" },
			{ "Picture/UI/StageSelect/GL_UI_StageTitle3.png" },
			{ "Picture/UI/StageSelect/GL_UI_StageTitle4.png" },
			{ "Picture/UI/StageSelect/GL_UI_StageTitle5.png" },
			{ "Picture/UI/StageSelect/GL_UI_StageTitle6.png" },
			{ "Picture/UI/StageSelect/GL_UI_StageTitle7.png" },
			{ "Picture/UI/StageSelect/GL_UI_StageTitle8.png" },
			{ "Picture/UI/StageSelect/GL_UI_StageTitle9.png" },
			{ "Picture/UI/StageSelect/GL_UI_StageTitle10.png" },
			{"Picture/UI/Credit/GL_UI_C_Takada.png"},
			{"Picture/UI/Credit/GL_UI_C_Takada.png"},
			{"Picture/UI/Credit/GL_UI_C_Takada.png"},
			{"Picture/UI/Credit/GL_UI_C_Takada.png"},
...
namespace UI {
	...
	_declspec(selectany) vector<PICTURE_TYPE> TUTORIAL_LIST = {
		{ SENTENCE,  {
			{ "Picture/UI/Tutorial/GL_UI_TutorialText1_1.png" },
			{ "Picture/UI/Tutorial/GL_UI_TutorialText1_2.png" },
			{ "Picture/UI/Tutorial/GL_UI_TutorialText1_3.png" },
			{ "Picture/UI/Tutorial/GL_UI_TutorialText2_1.png" },
			{ "Picture/UI/Tutorial/GL_UI_TutorialText2_2.png" },
			{ "Picture/UI/Tutorial/GL_UI_TutorialText2_3.png" },
			{ "Picture/UI/Tutorial/GL_UI_TutorialText2_4.png" },
			{ "Picture/UI/Tutorial/GL_UI_TutorialText2_5.png" },
			{ "Picture/UI/Tutorial/GL_UI_TutorialText3_1.png" },
			{ "Picture/UI/Tutorial/GL_UI_TutorialText4_1.png" },
			{ "Picture/UI/Tutorial/GL_UI_TutorialText4_2.png" },
			{ "Picture/UI/Tutorial/GL_UI_TutorialText5_1.png" },
			{ "Picture/UI/Tutorial/GL_UI_TutorialText5_2.png" },
			{ "Picture/UI/Tutorial/GL_UI_TutorialText5_3.png" },
			{ "Picture/UI/Tutorial/GL_UI_TutorialText5_4.png" },
			{ "Picture/UI/Tutorial/GL_UI_TutorialText6_1.png" },
			{ "Picture/UI/Tutorial/GL_UI_TutorialText6_2.png" },
			{ "Picture/UI/Tutorial/GL_UI_TutorialText7_1.png" },
			{ "Picture/UI/Tutorial/GL_UI_TutorialText7_2.png" },
			{ "Picture/UI/Tutorial/GL_UI_TutorialText8_1.png" },
			{ "Picture/UI/Tutorial/GL_UI_TutorialText8_2.png" },
			{ "Picture/UI/Tutorial/GL_UI_TutorialText9_1.png" },
			{ "Picture/UI/Tutorial/GL_UI_TutorialText9_2.png" },
			{ "Picture/UI/Tutorial/GL_UI_TutorialText10_1.png" },
			{ "Picture/UI/Tutorial/GL_UI_TutorialText10_2.png" },
			{ "Picture/UI/Tutorial/GL_UI_TutorialText11_1.png" },
			{ "Picture/UI/Tutorial/GL_UI_TutorialText11_2.png" },
		}},
		{INTERACT_KEY_MYLGIHT_ON , {
...
namespace ILLUST {
	...
	_declspec(selectany) vector<PICTURE_TYPE> GIMMICK_LIST = {
		...
		{GOAST_PASTIME , {
			{"Picture/Illust/Gimmick/GL_Gimmick_PastimeGhost1.png"},
			{"Picture/Illust/Gimmick/GL_Gimmick_PastimeGhost2.png"},
		}},
		{GOAST_PASTIME_EYE , {
			{"Picture/Illust/Gimmick/GL_Gimmick_PastimeGhost3.png"},
			{"Picture/Illust/Gimmick/GL_Gimmick_PastimeGhost4.png"},
		}},
		{GOAST_SENSITIVE , {
			{"Picture/Illust/Gimmick/GL_Gimmick_SensitiveGhost1.png"},
			{"Picture/Illust/Gimmick/GL_Gimmick_SensitiveGhost2.png"},
		}},
		{GOAST_SENSITIVE_EYE , {
			{"Picture/Illust/Gimmick/GL_Gimmick_SensitiveGhost3.png"},
			{"Picture/Illust/Gimmick/GL_Gimmick_SensitiveGhost4.png"},
		}},
		//{PISHER ,{
