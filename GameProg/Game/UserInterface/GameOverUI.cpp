...
void GameOverUI::Initialize()
{
	...
	auto picture = shared_ptr<Picture>(new Picture({ scrX / 2,200 }, 0.5, "Picture/UI_16.png", E_PIVOT::CENTER, E_SORT::SORT_UI));
	UserInterface::AddPictureInUI(picture);

	picture = shared_ptr<Picture>(new Picture({ scrX / 2,400 }, 0.5, "Picture/UI_53.png", E_PIVOT::CENTER, E_SORT::SORT_UI));
	UserInterface::AddPictureInUI(picture);
